...
```
| [YYYY-MM-DD] | COMMIT | [commit subject, ≤8 words] | [short hash] | findings [raw]→[survived] · deferred [n] · size-budget [ok/warn] · evidence [ok/warn/—] · docs-budget [ok/warn] · map-deltas [n swept/—] |
```
