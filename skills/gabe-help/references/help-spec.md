...
The Gabe Suite — 27 skills (each skill IS its slash command).
...
| gabe-feature | /gabe-feature [<phase>\|--range A..B] \| status \| backfill \| curate <artifact-subdir> <shot-nums…> \| release [--since <row>] | Feature coverage for a project's Testing Command Center — translate a shipped feature into its lens card, diagrams, and evidence narration over machine-deriv… |
