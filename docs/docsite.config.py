    ...
    },
    {
        ...
        "docs": [
            ...
            {"slug": "skill-map", "source_md": "skill-map.md", "title": "The skill map — and what fires each skill",
             ...
             "summary": "All 28 skills by group, the machinery behind each, and the wiring question the roster cannot answer: which skills can start on their own, and which fifteen only run when you remember them.",
             "swatch": "#7a5a2b"},
