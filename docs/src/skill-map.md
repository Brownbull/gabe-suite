# The skill map — 28 skills, and what fires each one

The suite is 28 skills. This page answers two questions the roster alone cannot: **what each one is for**, and **how it is reached** — because a skill nothing fires is only as available as your memory of it.
