...
BODY = f'''<div class="artifact-page">
  <header>
    <p style="font-size:var(--fs-min);letter-spacing:.18em;text-transform:uppercase;color:var(--accent);margin:0">gabe universe · gustify example · order of work 2 of 3 · draft</p>
...
''') + sec(7, 'alert', 'Gaps the map does not close', 'honest residue', f'''
    <div class="grid3">
...
''') + sec(8, 'bar', 'Provenance', 'how this was measured', f'''
    <div class="grid3">
