...
var _TICO_ORDER=[["labels","T0…T3 labels"],["bars","rising bars"],["dots","filled dots"],["layers","stacked layers"],["grid","detail grid"]];
window.__uniTierIcoSet=window.__uniTierIcoSet||"labels";
window.__uniRenderTierIcons=function(){ var fn=_TICO[window.__uniTierIcoSet]||_TICO.labels;
