# Command-Time Gabe-Lens Explanations

`/gabe-plan`, `/gabe-execute`, and `/gabe-review` print an output-only `**Gabe-Lens block**` after their normal result material. `/gabe-commit` prints the shorter output-only `**Gabe-Lens brief**`.
