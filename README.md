...
| `/gabe-map` | The codebase map as 18 MCP tools (who_calls · touches · owner_of · cases_for · entity_context · entity_shape · map_status · find · outline · center_overview · blast_radius · map_census · map_diff · center_status · review_drift · trace · gates · entity_models); status / register / probe |
