...
<!-- Optional Center column (command-center projects only): append `| Center |`; ⬜ → ✅ written by /gabe-cc-update when it covers the shipped phase. Absent → /gabe-next treats it as ✅. -->
