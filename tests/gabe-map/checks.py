...
def run(T):
    ...
    ok(names == sorted(["map_status", "entity_context", "touches", "who_calls", "entity_shape", "cases_for", "owner_of"]), "seven v1 tools listed", names)
    ...
    ok(all(len(t.get("description", "")) <= 220 for t in tools), "descriptions ≤ 220 chars")
