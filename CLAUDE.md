...
| **gabe-feature** | 1.2.0 | Command-center feature coverage — card/diagrams/narration over machine facts; absent-angle verdict-as-label + grow-it prompt; status, backfill, curate |
